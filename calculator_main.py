...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        layout_operation.addWidget(button_minus, 2, 1)
        layout_operation.addWidget(button_product, 2, 2)
        ...
        ### %, CE, C, 1/x, x^2, x^(1/2) 버튼 을 layout_operation 레이아웃에 추가
        ...
        layout_operation.addWidget(button_equal, 2, 3)
